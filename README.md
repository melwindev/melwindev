...
### 🚀 Computer Science & Engineering Student @ MNNIT Allahabad
I am a developer passionate about building aesthetically pleasing and functionally robust applications. Currently focusing on **Android Development**, **Python Automation**, and exploring the depths of **Linux environments**.

---

## 🛠️ Tech Stack

- **Languages:** C, Python (Pandas, MoviePy), Java, Kotlin, Bash Scripting
- **Mobile:** Android Studio, Android SDK, Android Palette API, Material Design 3
- **Tools:** Git, GitHub, FFmpeg, VS Code, MoviePy
- **Operating Systems:** Advanced Linux User (Pop!_OS & Arch Linux)

---

## 🛠️ Media Engineering & Architecture
...
- **Solid Foundation:** Developed custom background playback services and media session indexing.

---

## 📈 Technical Focus
- **Languages:** Kotlin, Java, Python, C, Bash
- **Android:** Jetpack Compose, Media3/ExoPlayer, Coroutines, Hardware Acceleration
- **Linux:** Advanced System Customization (Arch/Pop!_OS), Kernel Optimization, Dotfile Management

---

## 🔭 What I'm working on
- 🛠️ Improving my **Android** development skills with Jetpack Compose.
- 🤖 Automating video workflows with **Python** (Viral Reel Generator).
- 🐧 Constantly "ricing" and optimizing my **Arch Linux** workflow via dotfiles.
